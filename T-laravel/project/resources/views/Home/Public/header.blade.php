...
<body>
<script src="{{asset('Home/js/jquery-3.1.0.min.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('Home/js/sxb.js')}}"></script>
<style>
    .one_qcode{
        position:absolute;
        top:190px;
...
<div class="qing tibg">
    <div class="juzhong">
        <div class="lf weiz">
            ...
            <span> &gt; </span>
            <a href="product-list.php?top_id=3">
                金银币      </a>
            <span> &gt; </span>
            <a href="product.php?parent_id=6">
                生肖系列      </a>
            <span> &gt; </span>
            <a href="product.php?cat_id=92">
                {{$goods->cate_name}}      </a>
        </div>
    </div>
</div>