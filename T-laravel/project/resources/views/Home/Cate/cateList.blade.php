...
<div class="qing juzhong">
    ...
    <div class="rf" style="width:955px;">
        ...
        <dl class="yplb">
            ...
            <dd> <a href='{{url('Home/Goods/detail')}}?id={{$v->id}}' class="yptu">

                    <img  class="lazy"  data-original="{{asset("/upload/$v->goods_pic")}}" width="209" height="209"></a>
                <div class="ypmc">
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                $("img.lazy").lazyload({
                    placeholder : "img/11.jpg", //用图片提前占位
